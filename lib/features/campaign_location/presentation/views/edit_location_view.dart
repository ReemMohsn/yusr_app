                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      // 2. حقل الوصف (تم تعريفه باستخدام locale)
                      LocationInputCard(
                        title: locale.locationDescription, // تأكدي من وجود هذا المفتاح في locale
                        child: _buildTextField(
                          _descriptionController, 
                          locale.enterLocationDescription, // تأكدي من وجود هذا المفتاح في locale
                          null
                        ),
                      ),
                      SizedBox(height: 16.h),
...
//         leading: const UnconstrainedBox(child: CustomGoldenBackButton()),
//       ),
//       // استخدمنا SafeArea هنا لحماية منطقة الأزرار السفلية
//       body: SafeArea(
//         child: Column(
//           children: [
//             Expanded(
//               child: SingleChildScrollView(
//                 // أضفنا padding سفلي إضافي للتأكد من عدم تداخل المحتوى مع منطقة الأزرار عند التمرير
//                 padding: EdgeInsets.fromLTRB(20.w, 20.h, 20.w, 10.h),
//                 child: Form(
//                   key: _formKey,
//                   child: Column(
...
//                       LocationInputCard(
//                         title: locale.locationName,
//                         child: _buildTextField(_nameController, locale.enterLocationName, (v) => (v == null || v.isEmpty) ? locale.enterRequiredData : null),
//                       ),
//                       SizedBox(height: 16.h),
...
//                       LocationInputCard(
//                         title: "وصف الموقع",
//                         child: _buildTextField(_descriptionController, "أدخل وصفاً للموقع (اختياري)", null),
//                       ),
//                       SizedBox(height: 16.h),

//                       // 3. الخريطة (قللنا الارتفاع قليلاً ليتناسب مع الشاشات المتوسطة)
//                       LocationInputCard(
//                         title: locale.chooseCoordinates,
//                         height: 340.h, 
//                         child: ClipRRect(
...
//             // منطقة الأزرار - تم فصلها بديكور خفيف لتمييزها
//             Container(
//               padding: EdgeInsets.symmetric(horizontal: 20.w, vertical: 15.h),
...
//                           Icon(Icons.save_rounded, color: AppColor.golden, size: 20.sp),
//                           SizedBox(width: 8.w),
//                           Text(locale.saveLocation, style: TextStyle(color: AppColor.golden, fontWeight: FontWeight.bold, fontSize: 16.sp)),
//                         ],
//                       ),
//                     ),
//                   ),
...
//                       ),
//                       onPressed: () => Navigator.pop(context),
//                       child: Text(locale.cancel, style: TextStyle(color: const Color(0xFF344054), fontWeight: FontWeight.bold, fontSize: 16.sp)),
//                     ),
//                   ),
//                 ],
//               ),
...
//           focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12.r), borderSide: const BorderSide(color: AppColor.golden, width: 1.5)),
//           contentPadding: EdgeInsets.symmetric(horizontal: 16.w, vertical: 15.h),
//         ),
//       ),
//     );
