...
///
// ============================================================
// counter_details_card.dart
// بطاقة التفاصيل — مُضاف إليها أزرار التصحيح اليدوي (+ و -)
//
// التغييرات:
//   ✅ زر (+) لزيادة شوط يدوياً
//   ✅ زر (-) لإنقاص شوط يدوياً
//   ✅ تُعرض فقط أثناء التشغيل (isRunning=true)
// ============================================================
