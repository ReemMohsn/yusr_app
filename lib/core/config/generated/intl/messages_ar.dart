...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addNumberBtn": MessageLookupByLibrary.simpleMessage("إضافة الرقم"),
    "addNumberTitle": MessageLookupByLibrary.simpleMessage(
      "إضافة رقم الهاتف السعودي",
    ),
    ...
    "groupNotAssignedBody": MessageLookupByLibrary.simpleMessage(
      "لم يتم تعيينك ضمن مجموعة حتى الآن، يُرجى التواصل مع مدير الحملة.",
    ),
    ...
    "note1": MessageLookupByLibrary.simpleMessage("تأكد من أن الرقم يبدأ بـ 5"),
    "note2": MessageLookupByLibrary.simpleMessage(
      "الرقم يجب أن يكون مكوناً من 9 أرقام",
    ),
    "note3": MessageLookupByLibrary.simpleMessage(
      "تأكد من صحة الرقم لأنه سيستخدم للتواصل معك",
    ),
    "note4": MessageLookupByLibrary.simpleMessage(
      "يمكنك تعديل الرقم في أي وقت",
    ),
    ...
    "saudiPhoneHint": MessageLookupByLibrary.simpleMessage("مثال: 501234567"),
    "saudiPhoneImportance": MessageLookupByLibrary.simpleMessage(
      "أهمية الرقم السعودي",
    ),
    "saudiPhoneImportanceDesc": MessageLookupByLibrary.simpleMessage(
      "رقم الهاتف المحلي السعودي ضروري للتواصل معك داخل المملكة أثناء رحلة الحج. تأكد من صحة الرقم.",
    ),
    "saudiPhoneMustBe9Digits": MessageLookupByLibrary.simpleMessage(
      "يجب أن يتكون الرقم من 9 أرقام",
    ),
